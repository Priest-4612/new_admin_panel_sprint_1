    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('фильм', 'Movie'), ('тв шоу', 'Tv Show')], db_index=True, default='фильм', max_length=255, verbose_name='type')),
            ],
            options={
                'verbose_name': 'movie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('актер', 'Actor'), ('директор', 'Director'), ('продюсер', 'Producer')], default='актер', max_length=255, verbose_name='role')),
